...
{ 
  logging::log pen("manager", "windows::manager", "Internal window-ring manager initialized.");
...
windows::manager::~manager()
{
  logging::log pen("~manager", "windows::manager", "Destroying internal window-ring manager.");
...
{
  logging::log pen("nodes_add", "windows::manager", "Adding new window-node to window-ring.");
...
{
  logging::log pen("nodes_clear", "windows::manager", "Clearing all nodes in window-ring.");
